...
namespace StockTenDayLineWarning.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenDayAverage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    StockName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    WarningType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    WarningPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TenDayAverage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TriggerTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    TriggerVolume = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockWarnings", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockQuotes_StockCode_TradeDate",
                table: "StockQuotes",
